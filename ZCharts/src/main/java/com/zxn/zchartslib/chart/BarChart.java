...
import com.zxn.zchartslib.render.BarChartRender;
import com.zxn.zchartslib.render.XAxisOffsetRender;
import com.zxn.zchartslib.render.YAxisRender;
...
public class BarChart extends BarLineCurveChart<IBarData> implements IBarChart {
    ...
    protected void axisScale() {
        ...
        mXAxisRender = new XAxisOffsetRender(mXAxisData);
